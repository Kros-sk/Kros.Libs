...
namespace Kros.Net
{
    ...
    public static class HttpClientExtensions
    {
        ...
        /// <remarks>This method is useful mainly in integration tests of controllers, when you need to POST a form which
        /// requires anti-forgery token. This token is generated by the GET request of the form.</remarks>
        ...
        /// <remarks>Resulting list is created from all the public non-indexed properties of object <paramref name="data"/>.</remarks>
        ...
        /// <returns>List of data. Empty list is returned if no data was provided.</returns>
        /// <remarks>Resulting list is created from all the public non-indexed properties of object <paramref name="data"/>.
        /// If <paramref name="antiForgeryToken"/> is provided, it is added to the list with the key <see cref="AntiForgeryTokenFieldName"/>.
        /// </remarks>
